%    Title: FinalBirdoidObjectAvoidanceCode
...
xOfT = [1.0*cos(tList./12-pi/4); x2Vec];
yOfT = [0.7*sin(-tList./12-pi/4); y2Vec];
...
initialPos = [-1.2, 1.2, -0.5, -0.5, -1.0, 1.0, 0.5, 0.5;
                  0.0, 0.0,  -0.7, 0.7, 0.4, -0.5, -0.7, 0.7;
...
% Initialize video
if videoFLag 
    vid = VideoWriter('CompleteSaturatedExampleVideo.mp4', 'MPEG-4');
    vid.Quality = 100;
    vid.FrameRate = 72;
    open(vid);
